...
var validQueries = []string{
	...
	`SELECT * FROM abucket WHERE ANY children.age > 25 OVER children END`,
	`SELECT * FROM abucket WHERE ALL child.age > 25 OVER child IN children END`,
	`SELECT * FROM abucket WHERE ALL children.age > 25 OVER children END`,
	...
	`SELECT * FROM abucket WHERE FIRST children OVER children WHEN children.age > 25 END`,
	...
	`SELECT * FROM tutorial WHERE FIRST collection OVER collection END`,
