...
var validQueries = []string{
	...
	`SELECT * FROM bucket WHERE ANY child.age > 25 OVER child IN children END`,
	`SELECT * FROM bucket WHERE ALL child.age > 25 OVER child IN children END`,
	`SELECT * FROM bucket WHERE ALL child.age > 25 OVER child IN children[0] END`,
	`SELECT * FROM bucket WHERE ALL child.age > 25 OVER child IN a.children[0] END`,
	`SELECT * FROM bucket WHERE ALL child.age > 25 OVER child IN b.a.children[0] END`,
	`SELECT * FROM bucket WHERE ALL child.age > 25 OVER child IN b.a.children END`,
	`SELECT * FROM bucket WHERE ALL child.age > 25 OVER child IN some.my.children END`,
	...
	`SELECT * FROM bucket WHERE FIRST child OVER child IN children WHEN child.age > 25 END`,
