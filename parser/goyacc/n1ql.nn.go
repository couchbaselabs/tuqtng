...
func (yylex Lexer) Lex(lval *yySymType) int {
	for !yylex.isDone() {
		...
		case 21: //[mM][iI][sS][sS][iI][nN][gG]/
			{
				logDebugTokens("MISSING")
				return MISSING
			}
		case 22: //[vV][aA][lL][uU][eE][dD]/
			{
				logDebugTokens("VALUED")
				return VALUED
			}
		case 23: //[sS][eE][lL][eE][cC][tT]/
			{
				logDebugTokens("SELECT")
				return SELECT
			}
		case 24: //[aA][sS]/
			{
		...
		case 27: //[wW][hH][eE][rR][eE]/
			{
				logDebugTokens("WHERE")
				return WHERE
			}
		case 28: //[oO][rR][dD][eE][rR]/
			{
				logDebugTokens("ORDER")
				return ORDER
			}
		case 29: //[bB][yY]/
			{
		...
		case 33: //[oO][fF][fF][sS][eE][tT]/
			{
				logDebugTokens("OFFSET")
				return OFFSET
			}
		case 34: //[eE][xX][pP][lL][aA][iI][nN]/
			{
				logDebugTokens("EXPLAIN")
				return EXPLAIN
			}
		case 35: //[dD][iI][sS][tT][iI][nN][cC][tT]/
			{
				logDebugTokens("DISTINCT")
				return DISTINCT
			}
		case 36: //[uU][nN][iI][qQ][uU][eE]/
			{
				logDebugTokens("UNIQUE")
				return UNIQUE
			}
		case 37: //[cC][aA][sS][eE]/
			{
		...
		case 46: //[gG][rR][oO][uU][pP]/
			{
				logDebugTokens("GROUP")
				return GROUP
			}
		case 47: //[bB][yY]/
			{
		...
		case 48: //[hH][aA][vV][iI][nN][gG]/
			{
				logDebugTokens("HAVING")
				return HAVING
			}
		case 49: //[cC][rR][eE][aA][tT][eE]/
			{
				logDebugTokens("CREATE")
				return CREATE
			}
		case 50: //[dD][rR][oO][pP]/
			{
		...
		case 52: //[uU][sS][iI][nN][gG]/
			{
				logDebugTokens("USING")
				return USING
			}
		case 53: //[iI][nN][dD][eE][xX]/
			{
				logDebugTokens("INDEX")
				return INDEX
			}
		case 54: //[oO][nN]/
			{
		...
		case 55: //[pP][rR][iI][mM][aA][rR][yY]/
			{
				logDebugTokens("PRIMARY")
				return PRIMARY
			}
		case 56: //[aA][rR][rR][aA][yY]/
			{
				logDebugTokens("ARRAY")
				return ARRAY
			}
		case 57: //[aA][lL][tT][eE][rR]/
			{
				logDebugTokens("ALTER")
				return ALTER
			}
		case 58: //[bB][eE][tT][wW][eE][eE][nN]/
			{
				logDebugTokens("BETWEEN")
				return BETWEEN
			}
		case 59: //[bB][uU][cC][kK][eE][tT]/
			{
				logDebugTokens("BUCKET")
				return BUCKET
			}
		case 60: //[cC][aA][sS][tT]/
			{
		...
		case 61: //[cC][oO][lL][lL][aA][tT][eE]/
			{
				logDebugTokens("COLLATE")
				return COLLATE
			}
		case 62: //[dD][aA][tT][aA][bB][aA][sS][eE]/
			{
				logDebugTokens("DATABASE")
				return DATABASE
			}
		case 63: //[dD][eE][lL][eE][tT][eE]/
			{
		...
		case 65: //[eE][xX][cC][eE][pP][tT]/
			{
				logDebugTokens("EXCEPT")
				return EXCEPT
			}
		case 66: //[eE][xX][iI][sS][tT][sS]/
			{
				logDebugTokens("EXISTS")
				return EXISTS
			}
		case 67: //[iI][fF]/
			{
		...
		case 68: //[iI][nN][lL][iI][nN][eE]/
			{
				logDebugTokens("INLINE")
				return INLINE
			}
		case 69: //[iI][nN][sS][eE][rR][tT]/
			{
				logDebugTokens("INSERT")
				return INSERT
			}
		case 70: //[iI][nN][tT][eE][rR][sS][eE][cC][tT]/
			{
				logDebugTokens("INTERSECT")
				return INTERSECT
			}
		case 71: //[iI][nN][tT][oO]/
			{
		...
		case 74: //[uU][nN][iI][oO][nN]/
			{
				logDebugTokens("UNION")
				return UNION
			}
		case 75: //[uU][pP][dD][aA][tT][eE]/
			{
				logDebugTokens("UPDATE")
				return UPDATE
			}
		case 76: //[pP][oO][oO][lL]/
			{
		...
		case 80: //\{/
			{
				logDebugTokens("LBRACE")
				return LBRACE
			}
		case 81: //\}/
			{
				logDebugTokens("RBRACE")
				return RBRACE
			}
		case 82: //\,/
			{
				logDebugTokens("COMMA")
				return COMMA
			}
		case 83: //\:/
			{
		...
		case 84: //\[/
			{
				logDebugTokens("LBRACKET")
				return LBRACKET
			}
		case 85: //\]/
			{
				logDebugTokens("RBRACKET")
				return RBRACKET
			}
		case 86: //[tT][rR][uU][eE]/
			{
		...
		case 89: //([0-9]|[1-9][0-9]*)(\.[0-9][0-9]*)([eE][+\-]?[0-9][0-9]*)?/
			{
		...
		case 90: //([0-9]|[1-9][0-9]*)(\.[0-9][0-9]*)?([eE][+\-]?[0-9][0-9]*)/
			{
				lval.f, _ = strconv.ParseFloat(yylex.Text(), 64)
				logDebugTokens("NUMBER - %f", lval.f)
				return NUMBER
