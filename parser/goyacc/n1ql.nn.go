    ...
    case 76:  //[pP][oO][oO][lL]/
{
    ...
    case 77:  //[sS][aA][tT][iI][sS][fF][iI][eE][sS]/
{
                    logDebugTokens("SATISFIES"); return SATISFIES
                  }
    case 78:  //[eE][vV][eE][rR][yY]/
{
                    logDebugTokens("EVERY"); return EVERY
                  }
    case 79:  //[uU][nN][nN][eE][sS][tT]/
{
    ...
    case 92:  //([0-9]|[1-9][0-9]*)(\.[0-9][0-9]*)([eE][+\-]?[0-9][0-9]*)?/
{
    ...
    case 93:  //([0-9]|[1-9][0-9]*)(\.[0-9][0-9]*)?([eE][+\-]?[0-9][0-9]*)/
{
                    lval.f,_ = strconv.ParseFloat(yylex.Text(), 64);
                    logDebugTokens("NUMBER - %f", lval.f);
                    return NUMBER
