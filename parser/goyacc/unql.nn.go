    ...
    case 49:  //[vV][iI][eE][wW]/
{
    ...
    case 50:  //[uU][sS][iI][nN][gG]/
{
                    logDebugTokens("USING"); return USING
                  }
    case 51:  //[iI][nN][dD][eE][xX]/
{
